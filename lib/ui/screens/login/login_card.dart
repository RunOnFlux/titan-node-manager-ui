...
class LoginPage extends StatelessWidget with GetItMixin {
  ...
  Future<String?> attemptLogIn(String username, String password) async {
    var uri = Uri.parse('http://5.161.92.90:4444/api/login');
  ...
  Future<int> attemptSignUp(String username, String password) async {
    var uri = Uri.parse('http://5.161.92.90:4444/api/signup');
    print('username: $username');
    print('password: $password');
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: Center(
          child: HomeScreen(),
          // FutureBuilder(
          //   future: http.read(Uri.parse('http://5.161.92.90:4444/api/data'), headers: {"authorization": jwt}),
